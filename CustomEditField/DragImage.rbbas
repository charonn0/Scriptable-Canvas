...
Protected Module DragImage
	...
	#tag Method, Flags = &h0
		Sub SetImage(extends d as Dragitem, p as Picture)
		    ...
		    soft declare function SetDragImageWithCGImage lib "Carbon.framework" (inDrag as Integer, inCGImage as Ptr, inImageOffsetPt as Ptr, inImageFlags as UInt32) as Integer
		    
		    soft declare function CGImageGetHeight lib "Carbon.framework" (image as Ptr) as UInt32
		    soft declare function CGImageGetWidth lib "Carbon.framework" (image as Ptr) as UInt32
